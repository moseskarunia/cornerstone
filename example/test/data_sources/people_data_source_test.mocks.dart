...
// in example/test/data_sources/people_data_source_test.dart.
...
class MockDio extends _i1.Mock implements _i8.Dio {
  ...
  _i9.Future<_i6.Response<T>> patchUri<T>(Uri? uri,
      ...
      (super.noSuchMethod(
          ...
          as _i9.Future<_i6.Response<T>>);
  @override
  _i9.Future<_i6.Response<T>> resolve<T>(dynamic response) =>
      (super.noSuchMethod(Invocation.method(#resolve, [response]),
              returnValue: Future.value(_FakeResponse<T>()))
          as _i9.Future<_i6.Response<T>>);
  @override
  _i9.Future<_i6.Response<T>> reject<T>(dynamic err) =>
...
class MockResponse<T> extends _i1.Mock implements _i6.Response<T> {
  ...
  set headers(_i7.Headers? _headers) =>
      super.noSuchMethod(Invocation.setter(#headers, _headers),
          returnValueForMissingStub: null);
  @override
  _i2.RequestOptions get request =>
      (super.noSuchMethod(Invocation.getter(#request),
          returnValue: _FakeRequestOptions()) as _i2.RequestOptions);
  @override
  set request(_i2.RequestOptions? _request) =>
      super.noSuchMethod(Invocation.setter(#request, _request),
          returnValueForMissingStub: null);
  @override
